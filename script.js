...
class PTGApp {
    ...
    collectFormData() {
        ...
        if (equipmentType === 'Sala de Control') {
            ...
            data.compressors = this.collectNewCompressorsData(); // CORREGIDO: ahora usa la función correcta
    ...
    addNewCompressorsDataToPDF(doc, data, yPosition, lineHeight) {
        ...
        const fieldLabels = {
            ...
            mainRefrigerantTemp: 'Temperatura Refrigerante Sist.Principal',
            auxRefrigerantTemp: 'Temperatura Refrigerante Sist.Auxiliar',
            ...
            mainRefrigerantLevel: 'Nivel refrigerante Principal',
