...
class PTGApp {
    ...
    async generatePDF() {
        ...
        try {
            ...
            await this.sendDataToGoogleSheets(data);
    ...
    async sendDataToGoogleSheets(data) {
        try {
            ...
            const originalButtonText = document.getElementById('generatePdfBtn').textContent;
            document.getElementById('generatePdfBtn').textContent = 'Enviando datos a planillas...';
            ...
            alert('Datos enviados exitosamente a Google Sheets. El PDF se ha descargado.');
            
        } catch (error) {
            console.error('Error enviando datos a Google Sheets:', error);
            alert('PDF generado pero hubo un error al enviar los datos a Google Sheets. Por favor verifique su conexión.');
        } finally {
            document.getElementById('generatePdfBtn').textContent = 'Generar Informe PDF';
        }
    }
