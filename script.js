...
class PTGApp {
    constructor() {
        ...
        this.APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycby7bx9J5qzTNjTxgozXd_H_rXmD1xHEeIS9gpipF1Gy9RD8OiDlPiv0TiuxjLRFt569/exec';
    ...
    // ========== NUEVAS FUNCIONES DE INTEGRACIÓN CON GOOGLE SHEETS ==========
    ...
    async sendDataToGoogleSheets(formData) {
        try {
            ...
            // Nota: con 'no-cors' no podemos leer la respuesta, pero sabemos que se envió
    ...
    /**
     * Función para mostrar notificación de integración
     */
    ...
    async generatePDF() {
        ...
        try {
            ...
            // ========== NUEVA INTEGRACIÓN: Enviar datos a Google Sheets ==========
            try {
